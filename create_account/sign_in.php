...
1. HTML boilerplate (link any css and js files)
...
<body>
    <div id="container">
        <div class="sign-container">
            ...
            <form action="check_sign_in.php" method="POST" id="signInForm">
                <img src="../public/images/icons/akicon.jpg" alt="" srcset="" id="akicon">
                <p>
